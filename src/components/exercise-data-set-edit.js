      ...
      <tr className='exercise-data-edit'>
        ...
        <td>
          <form className='edit-set-weight'>
            <input type='text' id='edit-set-weight' data-set='1' placeholder='Set Weight' defaultValue={this.props.weight} size='30' onBlur={(event) => this.onEditSetWeight(this.props.id, this.props.exercise_id, this.props._id, event)} />
          </form>
        </td>
        <td>
          <form className='edit-set-repetitions'>
            <input type='text' id='edit-set-repetitions' placeholder='Set Repetitions' defaultValue={this.props.repetitions} size='30' onBlur={(event) => this.onEditSetRepetitions(this.props.id, this.props.exercise_id, this.props._id, event)} />
          </form>
        </td>
        <td><button className='delete-set-button' onClick= {(event) => this.onDeleteSet(this.props.id, this.props.exercise_id, this.props._id, event)}><img src='https://png.icons8.com/metro/1600/delete.png' alt='delete-icon' className='delete-set-icon' /></button></td>
      </tr>
    );
  }
}
